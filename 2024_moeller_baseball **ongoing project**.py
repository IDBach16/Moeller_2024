...
import pandas as pd
df = pd.read_csv('drive/My Drive/Moeller 2024 Season.csv')
...
plt.xlabel('Outcome')
plt.ylabel('%')
plt.title('1-0 Count Outcome % 2024 Season')
plt.show()
...
for pitcher in df_attack['Pitcher'].unique():
  ...
  plt.title('2024 Season Strike Percentage by Attack Zone - ' + pitcher)
  plt.show()
